...
interface Type{
    ...
    TaskAdding: string,
    ListTask: string,
    askingmarktask: string,
    addmore: boolean,
    Continiousaddingtask: string;  
    ReplacingTask: string,
    replacetaskname: string,
    Replacingcontinues: string,
};
...
async function TODOLIST(){
    ...
    while(addingmore){
       const TODO:Type = await inquirer.prompt([
        {
...

        {
            ...
            const taskaddings:Type = await inquirer.prompt([
                {
                ...
                if (taskaddings.TaskAdding) {
                    ...
                    const ReplaceTask: Type = await inquirer.prompt([
                        {
