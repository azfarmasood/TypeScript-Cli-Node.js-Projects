export function TOTAL_WORDS_COUNTERS(Text) {
...
export function TOTAL_CHARACTER_COUNTERS(Text) {
    return `${Text.length}`;
}
;
export function TOTAL_NUMBER_COUNTERS(Text) {
    let count = 0;
...
;
export function TOTAL_LETTER_COUNTERS(Text) {
    let count = 0;
...
;
export const TOTAL_UNIQUE_WORDS_COUNTERS = (Text) => {
...
export function TOTAL_UNIQUE_LETTER_COUNTERS(Text) {
...
export function TOTAL_SERIAL_NUMBER(counter) {
