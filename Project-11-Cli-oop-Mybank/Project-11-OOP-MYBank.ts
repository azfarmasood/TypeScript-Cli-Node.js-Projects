...
import { Customer } from "./BackAccount/Customer.js";
import { CASH_WITHDRAW, DEPOSIT_CASH, TRANSECTION_HISTORY } from "./BackAccount/BackAccount.js";
import { CUSTOMERS_INFO, ACCOUNT_BALANCE } from "./BackAccount/Customer.js";
            ...
            if(User1 && User2){
                if(customer){
                    ...
                    while (true){
                        const { Selection }: { Selection:string } = await inquirer.prompt([
                            {
                                ...
                                choices:[
                                    ...
                                    {name: chalk.bold.hex('#ff8243')("Show TranSection History"), value: "Show TranSection History"},
                        ...
                        else if(Selection === "Show TranSection History"){
                            TRANSECTION_HISTORY(customer);
                        }
